<div>
    <div class="container p-4 mt-16 bg-white rounded shadow grid grid-cols-4 grid-rows-2 gap-6">
        ...
        <div class="row-start-1 row-end-2 col-start-3 col-end-4 bg-slate-200 rounded relative overflow-hidden" x-intersect.threshold.50="$refs.img.src = $refs.img.dataset.img">
            <img x-ref="img" src="/assets/img/1x1.webp" data-img="/assets/img/category-roses.webp" alt="" class="w-full h-full object-cover">
        ...
        <div class="row-start-2 row-end-3 col-start-3 col-end-4 bg-slate-200 rounded relative overflow-hidden" x-intersect.threshold.50="$refs.img.src = $refs.img.dataset.img">
            <img x-ref="img" src="/assets/img/1x1.webp" data-img="/assets/img/category-bouquets.webp" alt="" class="w-full h-full object-cover">
            <a href="/" class="absolute top-0 left-0 w-full h-full p-4 flex flex-col justify-center bg-gradient-to-r from-lavender to-transparent text-white">
                <span class="text-xs">Категория</span>
                <h3 class="text-xl">Букеты</h3>
            </a>
        </div>
        <div class="row-start-2 row-end-3 col-start-4 col-end-5 bg-slate-200 rounded relative overflow-hidden" x-intersect.threshold.50="$refs.img.src = $refs.img.dataset.img">
            <img x-ref="img" src="/assets/img/1x1.webp" data-img="/assets/img/category-others.webp" alt="" class="w-full h-full object-cover">
            <a href="/" class="absolute top-0 left-0 w-full h-full p-4 flex flex-col justify-center bg-gradient-to-r from-lavender to-transparent text-white">
                <span class="text-xs">Категория</span>
